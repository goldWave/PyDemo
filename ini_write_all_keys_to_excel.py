...
# s_ini_paths_only = ["pt-BR.ini","ko-KR.ini"]
# dir_common_pre = "C:\\Users\\Administrator\\Documents\\source\\PRISMLiveStudio\\src\\prism\\launcher\\data\\locale\\"
...
def writeDiffToExcel(_path =s_ini_paths , _excel_name = "language"):
	...
	writeCompareKeyToExcel("C:\\Users\\Administrator\\Desktop\\4\\" + _excel_name + ".xls", _name, _mores, _dics, _isWriteAll=False)
